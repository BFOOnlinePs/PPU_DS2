...
namespace App\Http\Controllers\project\company_manager\attendance;
...
class AttendanceController extends Controller
{
    public function index()
    {
        ...
        return view('project.company_manager.attendance.index' , [
            'companies' => $companies ,
    ...
    public function fillter(Request $request)
    {
        ...
        $company = Company::where('c_manager_id' , auth()->user()->u_id)
        ->first();
        $students_companies = StudentCompany::where('sc_company_id' , $company->c_id)
        ...
        $html = view('project.company_manager.attendance.ajax.attendanceList' , [
            'data' => $data
        ])->render();
