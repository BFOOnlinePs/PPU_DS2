...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('admin.criteria.create') }}" method="post">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="c_criteria_name"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="5" readonly name="c_max_score" class="form-control"
                                        placeholder="علامة المعيار">
                                </div>
                            </div>
                            <div class="col-md-12">
