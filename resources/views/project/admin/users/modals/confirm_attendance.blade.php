<div class="swal-modal" role="dialog" aria-modal="true"><div class="swal-icon swal-icon--warning">
  ...
  </div><div class="swal-title" style="">Are you sure?</div><div class="swal-text" style="">Once deleted, you will not be able to recover this imaginary file!</div><div class="swal-footer"><div class="swal-button-container">
