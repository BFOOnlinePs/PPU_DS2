        ...
        <tbody>
            @foreach ($students_companies as $students_company)
                ...
                <tr>
                    ...
                    <td>
                        @foreach($students_company->user as $key)
                            {{ $key->name }},
                        @endforeach
{{--                        <a href="{{route('supervisors.companies.students' , ['id'=>$students_company->sc_company_id])}}" class="btn btn-primary btn-xs"><span class="fa fa-users"></span></a>--}}
                    </td>
                </tr>
            @endforeach
        </tbody>
